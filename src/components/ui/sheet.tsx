...
const SheetOverlay: Component<SheetPrimitive.DialogOverlayProps> = (props) => {
  ...
  return (
    <SheetPrimitive.Overlay
      class={cn(
        "fixed inset-0 z-50 bg-background/5 transition-all duration-100 data-[state=closed]:animate-out data-[state=closed]:fade-out data-[state=open]:fade-in",
        props.class,
      )}
      {...rest}
    />
